...
##################################################
    ...
    def train(self):
        ...
        for i in range(self.total_batch):
            ...
            _, loss, total_loss,pred, DAloss,pairloss = self.sess.run((self.optimizer, self.loss,self.total_loss,self.pred_y,self.DAloss,self.pair_loss),
                                    feed_dict={self.user_id: batch_users, self.item_id: batch_items, self.y: batch_labels,self.target_item_id:batch_targets, self.hot_item_id:batch_hot_items,self.long_item_id:batch_long_items})
